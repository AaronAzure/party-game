...
namespace BeautifulTransitions.Scripts.Transitions.GameActions.GameObject
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("Custom", "Beautiful Transitions/Transitions/Custom", "Custom transition where you can add your own callback methods")]
    public class GameActionCustom : GameActionTransitionGameObjectBase
    {
        /// <summary>
        ...
        {
            return new TransitionStep(ResolveTarget());
        }
    }
}
#endif