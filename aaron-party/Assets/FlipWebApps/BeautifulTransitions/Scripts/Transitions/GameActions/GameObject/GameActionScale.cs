...
namespace BeautifulTransitions.Scripts.Transitions.GameActions.GameObject
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("Scale", "Beautiful Transitions/Transitions/Scale", "Scale the specified transition.")]
    public class GameActionScale : GameActionTransitionGameObjectBase
    {
        [Tooltip("Scale at the start of the transition.")]
        public Vector3 StartScale = new Vector3(0, 0, 0);
        
        [Tooltip("Scale at the end of the transition.")]
        ...
        {
            return new Scale(ResolveTarget());
        }
        ...
        public override void SetupTransitionStep(TransitionStep transitionStep)
        {
            ...
            {
                transitionStepScale.StartValue = StartScale;
                transitionStepScale.EndValue = EndScale;
            }
