...
namespace BeautifulTransitions.Scripts.Transitions.GameActions.Screen.AbstractClasses
{
    public abstract class GameActionTransitionScreenBase : GameActionTransitionBase
    {
        ...
        [Tooltip("Whether to transition in or out.")]
        public TransitionDirectionType TransitionDirection = TransitionDirectionType.Out;
        ...
        public override void SetupTransitionStep(TransitionStep transitionStep)
        {
            ...
            {
                transitionStepScreen.StartValue = TransitionDirection == TransitionDirectionType.In ? 1 : 0;
                transitionStepScreen.EndValue = TransitionDirection == TransitionDirectionType.In ? 0 : 1;
                //transitionStepScreenWipe.SkipOnCrossTransition = SkipOnCrossTransition;
                transitionStepScreen.SceneChangeMode = SceneChangeMode;
                transitionStepScreen.SceneToLoad = SceneToLoad;
            }
