...
{
    [CustomEditor(typeof(GameActionVolume))]
    public class GameActionVolumeEditor : GameActionTransitionGameObjectBaseEditor
    {
        SerializedProperty _transitionModeProperty;
        SerializedProperty _startVolumeProperty;
        SerializedProperty _endVolumeProperty;
        ...
        protected override void Initialise()
        {
            ...
            _startVolumeProperty = serializedObject.FindProperty("StartVolume");
            _endVolumeProperty = serializedObject.FindProperty("EndVolume");
        }
        ...
        protected override void ShowFooterGUI() {
            ...
            {
                EditorGUILayout.PropertyField(_startVolumeProperty);
            }
            if (_transitionModeProperty.enumValueIndex != 2)
            {
                EditorGUILayout.PropertyField(_endVolumeProperty);
            }
        }
