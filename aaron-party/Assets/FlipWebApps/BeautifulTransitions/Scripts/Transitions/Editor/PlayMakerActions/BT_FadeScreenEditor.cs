...
using BeautifulTransitions.Scripts.Transitions.PlayMakerActions.Screen;
using HutongGames.PlayMakerEditor;
using UnityEditor;

namespace BeautifulTransitions.Scripts.Transitions.Editor.PlayMakerActions
{
    [CustomActionEditor(typeof(BT_FadeScreen))]
    public class BT_FadeScreenEditor : PlayMakerTransitionScreenEditor
    {
        /// <summary>
        ...
        protected override void ShowFooterGUI() {
            ...
            //var playMakerFadeScreen = target as PlayMakerFadeScreen;
