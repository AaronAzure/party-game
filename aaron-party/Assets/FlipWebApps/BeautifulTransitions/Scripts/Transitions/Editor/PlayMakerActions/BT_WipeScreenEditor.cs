...
{
    [CustomActionEditor(typeof(BT_WipeScreen))]
    public class BT_WipeScreenEditor : PlayMakerTransitionScreenEditor
    {
        /// <summary>
        ...
        protected override void ShowFooterGUI() {
            ...
            //var playMakerWipeScreen = target as PlayMakerWipeScreen;
            EditorGUILayout.LabelField("Wipe Screen Specific", EditorStyles.boldLabel);
            ShowSpecificSharedGUI();
            EditField("Texture");
            EditField("Color");
            EditField("MaskTexture");
            EditField("InvertMask");
            EditField("Softness");
        }
