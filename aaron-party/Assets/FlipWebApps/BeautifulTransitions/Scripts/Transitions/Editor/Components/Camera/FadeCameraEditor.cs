...
{
    [CustomEditor(typeof(FadeCamera))]
    public class FadeCameraEditor : TransitionBaseEditor
    {
        ...
        protected override void ShowTransitionInGUI() {
            GUILayout.Space(3f);
            EditorGUILayout.LabelField("Fade Camera Specific", EditorStyles.boldLabel);
