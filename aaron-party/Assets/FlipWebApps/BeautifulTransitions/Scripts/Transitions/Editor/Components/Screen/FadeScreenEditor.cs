...
namespace BeautifulTransitions.Scripts.Transitions.Editor.Components.Screen
{
    [CustomEditor(typeof(FadeScreen))]
    public class FadeScreenEditor : TransitionBaseEditor
    {
        SerializedProperty _inTextureProperty;
        SerializedProperty _inColorProperty;
        SerializedProperty _inSkipOnCrossTransitionProperty;
        SerializedProperty _outTextureProperty;
        SerializedProperty _outColorProperty;
        SerializedProperty _outSceneChangeModeProperty;
        SerializedProperty _outSceneToLoadProperty;
        ...
        protected override void OnEnable()
        {
            ...
            _inSkipOnCrossTransitionProperty = inConfigProperty.FindPropertyRelative("SkipOnCrossTransition");
            ...
            _outSceneChangeModeProperty = outConfigProperty.FindPropertyRelative("SceneChangeMode");
            _outSceneToLoadProperty = outConfigProperty.FindPropertyRelative("SceneToLoad");
            base.OnEnable();
        }
        ...
        protected override void ShowTransitionInGUI() {
            GUILayout.Space(3f);
            EditorGUILayout.LabelField("Fade Screen Specific", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(_inTextureProperty);
            EditorGUILayout.PropertyField(_inColorProperty);
            EditorGUILayout.PropertyField(_inSkipOnCrossTransitionProperty);
        }
        ...
        protected override void ShowTransitionOutGUI() {
            ...
            EditorGUILayout.PropertyField(_outSceneChangeModeProperty);
            EditorGUILayout.PropertyField(_outSceneToLoadProperty);
        }
    }
}
