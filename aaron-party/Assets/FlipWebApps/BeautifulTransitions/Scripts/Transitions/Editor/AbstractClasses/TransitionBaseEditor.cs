            ...
            TransitionBase.TransitionSettings transitionSettings, bool isInTransition)
        {
            ...
            if (property.isExpanded)
            {
                ...
                if (onTransitionStartActionReferencesProperty.isExpanded)
                {
                    ...
                    EditorGUILayout.BeginVertical();
                    if (isInTransition)
                        GameFramework.GameStructure.Game.Editor.GameActions.GameActionEditorHelper.DrawActions(serializedObject, onTransitionStartActionReferencesProperty, transitionSettings.OnTransitionStartActionReferences,
                ...
                if (onTransitionCompleteActionReferencesProperty.isExpanded)
                {
                    ...
                    EditorGUILayout.BeginVertical();
                    if (isInTransition)
                        GameFramework.GameStructure.Game.Editor.GameActions.GameActionEditorHelper.DrawActions(serializedObject, onTransitionCompleteActionReferencesProperty, transitionSettings.OnTransitionCompleteActionReferences,
