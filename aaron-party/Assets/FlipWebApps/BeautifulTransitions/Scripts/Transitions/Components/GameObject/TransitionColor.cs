...
namespace BeautifulTransitions.Scripts.Transitions.Components.GameObject
{
    ...
    public class TransitionColor : TransitionGameObjectBase
    {
        ...
        /// <summary>
        /// Gather any initial state - See TransitionBase for further details
        /// </summary>
        ...
        public override void SetupTransitionStepIn(TransitionStep transitionStep)
        {
            ...
            { 
                transitionStepColor.Gradient = InConfig.Gradient;
                transitionStepColor.EndValue = _originalColor;
            }
        ...
        public override void SetupTransitionStepOut(TransitionStep transitionStep)
        {
            ...
            if (transitionStepColor != null)
            {
                transitionStepColor.Gradient = OutConfig.Gradient;
                transitionStepColor.StartValue = transitionStepColor.GetCurrent();
            }
