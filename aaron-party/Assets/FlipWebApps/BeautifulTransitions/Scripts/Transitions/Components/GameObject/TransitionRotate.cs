...
namespace BeautifulTransitions.Scripts.Transitions.Components.GameObject
{
    ...
    public class TransitionRotate : TransitionGameObjectBase
    {
        ...
        {
            _originalRotation = ((TransitionSteps.Rotate)CreateTransitionStep()).OriginalValue;
        }
        ...
        {
            return new TransitionSteps.Rotate(Target, coordinateSpace: ConvertRotationMode());
        }
