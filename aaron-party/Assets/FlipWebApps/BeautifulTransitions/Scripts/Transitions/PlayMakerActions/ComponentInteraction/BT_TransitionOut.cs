...
{
    /// <summary>
    /// Find and transition out the specified transition.
    /// </summary>
    [ActionCategory("Beautiful Transitions")]
    [Tooltip("Transition out the specified transition component.")]
    [Title("Transition Out")]
    public class BT_TransitionOut : FsmStateAction
    {
        /// <summary>
        /// The target Transition
        /// </summary>
        [Tooltip("The target Transition")]
        [ObjectType(typeof(TransitionBase))]
        ...
        void PerformAction()
        {
            if (Target != null)
            {
                ((TransitionBase)Target.Value).TransitionOut();
            }
        }
    }
}
