...
namespace BeautifulTransitions.Scripts.Transitions.PlayMakerActions.GameObject.AbstractClasses
{
    public abstract class PlayMakerTransitionGameObjectBase : PlayMakerTransitionBase
    {
        [HutongGames.PlayMaker.Tooltip("The target gameobject upon which to perform the transition.")]
        [RequiredField]
        public FsmOwnerDefault Target;

        [HutongGames.PlayMaker.Tooltip("The transition mode relative to specified and current values.")]
