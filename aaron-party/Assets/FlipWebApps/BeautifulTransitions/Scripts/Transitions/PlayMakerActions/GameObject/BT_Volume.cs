...
namespace BeautifulTransitions.Scripts.Transitions.PlayMakerActions.GameObject
{
    ...
    [HutongGames.PlayMaker.Tooltip("Transition the volume on the specified target.")]
    [Title("Volume")]
    public class BT_Volume : PlayMakerTransitionGameObjectBase
    {
        [HutongGames.PlayMaker.Tooltip("Normalised volume at the start of the transition.")]
        [HasFloatSlider(0, 1)]
        public FsmFloat StartVolume = 0;
        
        [HutongGames.PlayMaker.Tooltip("Normalised volume at the end of the transition.")]
        [HasFloatSlider(0, 1)]
        public FsmFloat EndVolume = 0;
        ...
        {
            base.Reset();
            StartVolume = new FsmFloat();
            EndVolume = new FsmFloat();
        }
        ...
        {
            return new VolumeTransition(Fsm.GetOwnerDefaultTarget(Target));
        }
