...
{
    /// <summary>
    /// Controller for display item demo
    /// </summary>
    public class DisplayItemController : MonoBehaviour {
        ...
        public void Start()
        {
            DisplayItemHelper.SetAttention(AttentionButton.gameObject, true);
        }

        public void ShowClicked()
        {
            DisplayItemHelper.SetActiveAnimated(this, TestButton.gameObject, true);
        ...
        {
            DisplayItemHelper.SetActiveAnimated(this, TestButton.gameObject, false);
