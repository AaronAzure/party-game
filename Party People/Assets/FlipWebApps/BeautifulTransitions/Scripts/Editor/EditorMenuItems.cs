...
namespace BeautifulTransitions.Scripts.Editor {
    ...
    public class EditorMenuItems : MonoBehaviour {
        ...
        [MenuItem("Window/Beautiful Transitions/Homepage", false, 1100)]
        static void ShowHomepage()
        { 
            Process.Start(@"http://www.flipwebapps.com/beautiful-transitions");
        }

        [MenuItem("Window/Beautiful Transitions/Documentation", false, 1102)]
        static void ShowDocumentation()
        {
            Process.Start(@"http://www.flipwebapps.com/beautiful-transitions/");
        }

        [MenuItem("Window/Beautiful Transitions/Support Forum", false, 1103)]
        static void ShowSupportForum()
        {
            Process.Start(@"http://www.flipwebapps.com/forum/");
        }

        [MenuItem("Window/Beautiful Transitions/Contact", false, 1104)]
