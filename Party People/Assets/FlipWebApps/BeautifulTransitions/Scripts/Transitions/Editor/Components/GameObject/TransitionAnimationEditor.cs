...
namespace BeautifulTransitions.Scripts.Transitions.Editor.Components.GameObject
{
    ...
    public class TransitionAnimationEditor : TransitionGameObjectBaseEditor
    {
        SerializedProperty _inSpeedProperty;
        SerializedProperty _outSpeedProperty;

        protected override void OnEnable()
        {
            var inConfigProperty = serializedObject.FindProperty("InConfig");
            _inSpeedProperty = inConfigProperty.FindPropertyRelative("Speed");
            var outConfigProperty = serializedObject.FindProperty("OutConfig");
            _outSpeedProperty = outConfigProperty.FindPropertyRelative("Speed");
            base.OnEnable();
        }
        ...
        protected override void ShowTransitionInGUI() {
            GUILayout.Space(3f);
            EditorGUILayout.LabelField("Animation Specific", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(_inSpeedProperty);
        }
        ...
        protected override void ShowTransitionOutGUI() {
            GUILayout.Space(3f);
            EditorGUILayout.LabelField("Animation Specific", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(_outSpeedProperty);
        }
    }
}
