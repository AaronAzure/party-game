...
{
    public abstract class PlayMakerTransitionGameObjectBaseEditor : PlayMakerTransitionBaseEditor
    {
        /// <summary>
        ...
        protected virtual void ShowSpecificSharedGUI() {
            //var playMakerTransitionGameObjectBase = target as PlayMakerTransitionGameObjectBase;
            EditField("Target");
        }
    }
}
