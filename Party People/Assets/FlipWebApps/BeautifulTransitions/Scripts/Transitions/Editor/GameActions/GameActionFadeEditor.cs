...
{
    [CustomEditor(typeof(GameActionFade))]
    public class GameActionFadeEditor : GameActionTransitionGameObjectBaseEditor
    {
        SerializedProperty _transitionModeProperty;
        SerializedProperty _startTransparencyProperty;
        SerializedProperty _endTransparencyProperty;
        ...
        protected override void Initialise()
        {
            ...
            _startTransparencyProperty = serializedObject.FindProperty("StartTransparency");
            _endTransparencyProperty = serializedObject.FindProperty("EndTransparency");
        }
        ...
        protected override void ShowFooterGUI() {
            ...
            {
                EditorGUILayout.PropertyField(_startTransparencyProperty);
            }
            if (_transitionModeProperty.enumValueIndex != 2)
            {
                EditorGUILayout.PropertyField(_endTransparencyProperty);
            }
        }
