...
namespace BeautifulTransitions.Scripts.Transitions.GameActions.GameObject
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("Fade", "Beautiful Transitions/Transitions/Fade", "Fade the specified transition.")]
    public class GameActionFade : GameActionTransitionGameObjectBase
    {
        [Tooltip("Normalised transparency at the start of the transition.")]
        public float StartTransparency = 0;
        
        [Tooltip("Normalised transparency at the end of the transition.")]
        ...
        {
            base.Initialise();
            //originalTransparency = ((Fade)CreateTransitionStep()).OriginalValue;
        }
        ...
        {
            return new TransitionSteps.Fade(ResolveTarget());
        }
        ...
        {
            var transitionStepFade = transitionStep as TransitionSteps.Fade;
            if (transitionStepFade != null)
            {
                transitionStepFade.StartValue = StartTransparency;
                transitionStepFade.EndValue = EndTransparency;
            }
