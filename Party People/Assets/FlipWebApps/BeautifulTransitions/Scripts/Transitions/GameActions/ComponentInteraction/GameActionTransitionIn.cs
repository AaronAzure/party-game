...
namespace BeautifulTransitions.Scripts.Transitions.GameActions.ComponentInteraction
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("Transition In - Transition Component", "Beautiful Transitions/Component Interaction/Transition In - Transition Component", "Transition in the specified transition.")]
    public class GameActionTransitionIn : GameAction
    {
        /// <summary>
