...
#if GAME_FRAMEWORK
using BeautifulTransitions.Scripts.Transitions.GameActions.Screen.AbstractClasses;
using BeautifulTransitions.Scripts.Transitions.TransitionSteps;
using BeautifulTransitions.Scripts.Transitions.TransitionSteps.AbstractClasses;
using GameFramework.Helper;
using UnityEngine;

namespace BeautifulTransitions.Scripts.Transitions.GameActions.Screen
{
    /// <summary>
    /// GameAction to wipe the screen.
    /// </summary>
    [System.Serializable]
    [ClassDetails("Wipe Screen", "Beautiful Transitions/Screen/Wipe", "Wipe the screen.")]
    public class GameActionWipeScreen : GameActionTransitionScreenBase
    {
        ...
        public override void SetupTransitionStep(TransitionStep transitionStep)
        {
            ...
            if (transitionStepScreenWipe != null)
            {
                ...
                transitionStepScreenWipe.InvertMask = InvertMask;
                transitionStepScreenWipe.Color = Color;
                transitionStepScreenWipe.Texture = Texture;
                transitionStepScreenWipe.Softness = Softness;
            }
