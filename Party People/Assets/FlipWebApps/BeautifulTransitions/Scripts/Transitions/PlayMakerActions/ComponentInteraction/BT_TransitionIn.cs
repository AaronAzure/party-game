...
{
    /// <summary>
    /// Find and transition in the specified transition.

    /// </summary>
    [ActionCategory("Beautiful Transitions")]
    [Tooltip("Transition in the specified transition component.")]
    [Title("Transition In")]
    public class BT_TransitionIn : FsmStateAction
    {
        /// <summary>
        ...
        void PerformAction()
        {
            if (Target != null)
            {
                ((TransitionBase)Target.Value).TransitionIn();
            }
        }
    }
}
