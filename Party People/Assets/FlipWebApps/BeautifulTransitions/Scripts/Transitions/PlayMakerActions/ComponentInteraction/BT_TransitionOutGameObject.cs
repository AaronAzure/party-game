...
namespace BeautifulTransitions.Scripts.Transitions.PlayMakerActions.ComponentInteraction
{
    ...
    [Tooltip("Transition out components on the specified GameObject and any children (based upon component configuration).")]
    [Title("Transition Out - GameObject")]
    public class BT_TransitionOutGameObject : FsmStateAction
    {
        /// <summary>
