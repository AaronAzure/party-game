	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				// to avoid rounding errors with smoothstep below, restrict softness (otherwise e.g. mosaic 2 in demo doesn't clear properly).
				_Softness = clamp(_Softness, 0.00001, 0.99999);
